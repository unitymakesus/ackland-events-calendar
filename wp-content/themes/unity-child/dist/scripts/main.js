...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lazysizes__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routes_archive__ = __webpack_require__(17);
// Import parent JS
...
var routes = new __WEBPACK_IMPORTED_MODULE_2__util_Router__["a" /* default */]({
  ...
  archive: __WEBPACK_IMPORTED_MODULE_4__routes_archive__["a" /* default */],
});
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_getPosts__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__util_getOptions__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_clearResults__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__util_debounce__ = __webpack_require__(39);
...
var row = $('#js-posts-row');
var totalReturned = 0;
function loadPosts(options) {
  var current = parseInt(wrapper.attr('data-paged')) || '';
  var postType = wrapper.attr('data-context') || '';

  // Pass along next pagination to our request.
  options.paged = current + 1;

  Object(__WEBPACK_IMPORTED_MODULE_0__util_getPosts__["a" /* default */])(postType, options)
    .then(function (ref) {
      ...
      var totalPosts = headers['x-wp-total'];
...
function initPosts() {
  ...
  loadPosts(Object(__WEBPACK_IMPORTED_MODULE_1__util_getOptions__["a" /* default */])());
  ...
  function combineFilters() {
    ...
    filters.forEach(function (filter) {
      var selected = $(filter).find(':checked');
      var key = filter.getAttribute('data-fieldset');
  ...
  function doFiltering(options) {
    Object(__WEBPACK_IMPORTED_MODULE_2__util_clearResults__["a" /* default */])(wrapper, row);
    totalReturned = 0;
    loadPosts(options);
  }
  ...
  // Search.
  $('#js-filter-search').on('keyup paste', Object(__WEBPACK_IMPORTED_MODULE_3__util_debounce__["a" /* default */])(function (e) {
    // if (isBreakpoint('xs')) {
    //   return;
    // }
    ...
    var keysToIgnore = [9, 27, 37, 38, 39, 40, 17, 18, 93, 16, 20];
 ...
 */
var API_URL = '/wp-json/ackland/v1/';

var getPosts = function (postType, params) {
  var endpoint = API_URL + postType;

  console.log(params);

  return __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(endpoint, { params: params });
};
...
/* harmony default export */ __webpack_exports__["a"] = (getOptions);
 ...
 */
var clearResults = function (wrapper, row) {
...
/* harmony default export */ __webpack_exports__["a"] = (clearResults);
